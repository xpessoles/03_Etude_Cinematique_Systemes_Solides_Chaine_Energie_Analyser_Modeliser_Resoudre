...
Chapitre 2 -- Modélisation des systèmes mécaniques}{
}}
...
3 : Cinématique \\
Ch 2 : Modélisation -- Application 2 -- \ifthenelse{\boolean{prof}}{P}{E}%
}{
}}
...
\subparagraph*{}\textit{Donner les liaisons équivalentes des liaisons suivantes.}% Préciser le degré d'hyperstatisme.}
