...
\subparagraph{}\textit{Calculer les produits vectoriels suivants :}

\begin{multicols}{3}
\begin{itemize}
 \renewcommand{\labelitemi}{\tiny{$\blacksquare$}}
\item $\vect{i_0} \wedge \vect{j_0}$;
\item $\vect{j_0} \wedge\vect{k_0}$;
\item $\vect{j_0} \wedge \vect{j_1}$;
\item $\vect{j_0} \wedge\vect{k_1}$;
\item $\vect{i_0} \wedge \vect{i_2}$;
\item $\vect{k_1} \wedge \vect{k_0}$;
\item $\vect{i_0} \wedge \vect{j_2}$;
\item $\vect{i_2} \wedge \vect{j_1}$;
\item $\vect{j_2} \wedge \vect{j_0}$;
\item $\vect{k_1} \wedge \vect{i_2}$;
\item $\vect{i_0} \wedge \vect{k_1}$;
\item $\vect{j_2} \wedge \vect{i_2}$.
\end{itemize}
\end{multicols}
